...
@implementation TJTouSuBottomTableViewCell
...
{
    static NSString * ID = @"TJTouSuDetailBottomCell";
    TJTouSuBottomTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (cell == nil) {
        cell = [[[NSBundle mainBundle] loadNibNamed:@"TJComplaintAcceptCell" owner:self options:nil] objectAtIndex:3];
    }
    return cell;
}
