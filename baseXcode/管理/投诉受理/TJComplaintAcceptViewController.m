//
//  TJComplaintAcceptViewController.m
//  baseXcode
//
...
@interface TJComplaintAcceptViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation TJComplaintAcceptViewController
...
- (void)viewDidLoad {
    ...
    [self loadComplaintAcceptManagerList];
    
    [self loadTousuBaseData];
}
#pragma mark - setView
- (void)setHeaderView
{
...
- (void)setTableView
{
    ...
    tableView.mj_header = [MJRefreshNormalHeader headerWithRefreshingTarget:self refreshingAction:@selector(refreshCompliant)];
    tableView.mj_footer = [MJRefreshBackNormalFooter footerWithRefreshingTarget:self refreshingAction:@selector(loadMoreCompliant)];
    [self.view addSubview:tableView];
    self.tableView = tableView;
}
- (void)refreshCompliant
{
    self.page = 1;
    [self loadComplaintAcceptManagerList];
}
- (void)loadMoreCompliant
{
    self.page++;
    [self loadComplaintAcceptManagerList];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    TJComplaintAcceptBaseTableViewCell * cell = [TJComplaintAcceptBaseTableViewCell cellWithTableView:tableView];
...
- (void)loadComplaintAcceptManagerList
{
    NSString * url = @"wuye/tousurequest.jsp";
